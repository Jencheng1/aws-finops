...
# Sidebar navigation for better tab visibility
tab_options = {
...
with st.sidebar:
    ...
    st.markdown("---")
    st.caption("💡 All 9 modules are now easily accessible")
    st.caption("🔍 No zooming required!")

# Get the selected tab key
selected_key = tab_options[selected_tab]
...
if selected_key == "cost_intelligence":
...
if selected_key == "multi_agent_chat":
...
if selected_key == "business_context":
...
if selected_key == "resource_optimization":
...
if selected_key == "budget_prediction":
...
if selected_key == "executive_dashboard":
...
if selected_key == "report_generator":
...
if selected_key == "tag_compliance":
